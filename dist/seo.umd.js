...
__webpack_require__.d(__webpack_exports__, "article", function() { return /* reexport */ article; });
...
// CONCATENATED MODULE: ./src/functions/meta.js
/* harmony default export */ var meta = ({
  getMeta: function getMeta(title, description, img, canonical) {
    return {
      title: title,
      meta: [{
        hid: 'description',
...
// CONCATENATED MODULE: ./src/functions/article.js
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              $content = _ref.$content, error = _ref.error;
              _context.prev = 1;
              _context.next = 4;
              return $content('' + name).limit(100).fetch();
...
//# sourceMappingURL=seo.umd.js.map